...
function Events() {
    return (
        <div className="d-flex event-container">
            <Event img="./assets/Logos/eureka.png" fit="fit" name="EUREKA" desc="Eureka is not just a competition; it's a launchpad for your entrepreneurial dreams. In its 26th edition, Eureka is the largest platform for aspiring entrepreneurs to transform their innovative ideas into real-world business models. This event provides an exhilarating opportunity for you to pitch your visionary concepts and engage in stimulating Q&A sessions with experts."/>
            <Event img="./assets/Logos/pro.png" fit="fit" name="Pro Talks" desc="ProTalks aims to provide our students with insights into the world of entrepreneurship and business. We have the pleasure of hosting two esteemed experts, Shyam Sir Hathaliya and Hardik Sir Tarpara, who will be sharing their valuable expertise and experiences."/>
